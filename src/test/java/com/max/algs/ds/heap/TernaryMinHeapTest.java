...
public class TernaryMinHeapTest {
    ...
    public void extract() {
        ...
        assertDataEquals(new Comparable[]{1, 6, 2, 3, 10, 9, 7, 5, 4, 6}, heap.data);

        assertEquals(new Integer(1), heap.min());
        assertEquals(new Integer(1), heap.min());
        assertEquals(new Integer(1), heap.extract());
        assertEquals(9, heap.size());
        assertDataEquals(new Comparable[]{2, 6, 4, 3, 10, 9, 7, 5, 6}, heap.data);

        assertEquals(new Integer(2), heap.extract());
        assertEquals(8, heap.size());
        assertDataEquals(new Comparable[]{3, 6, 4, 6, 10, 9, 7, 5}, heap.data);
        ...
        assertDataEquals(new Comparable[]{6, 9, 7, 6, 10}, heap.data);

        assertEquals(new Integer(6), heap.extract());
        assertEquals(new Integer(6), heap.extract());
        assertEquals(3, heap.size());
        assertDataEquals(new Comparable[]{7, 9, 10}, heap.data);
        ...
        assertDataEquals(new Comparable[]{10}, heap.data);
    ...
    public void add() {
        ...
        assertDataEquals(new Comparable[]{}, heap.data);

        heap.add(5);
        assertFalse(heap.isEmpty());
        assertEquals(1, heap.size());
        assertDataEquals(new Comparable[]{5}, heap.data);

        heap.add(10);
        assertEquals(2, heap.size());
        assertDataEquals(new Comparable[]{5, 10}, heap.data);

        heap.add(2);
        assertEquals(3, heap.size());
        assertDataEquals(new Comparable[]{2, 10, 5}, heap.data);

        heap.add(3);
        heap.add(7);
        heap.add(9);
        heap.add(6);
        assertDataEquals(new Comparable[]{2, 6, 5, 3, 10, 9, 7}, heap.data);
